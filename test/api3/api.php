...
class Real extends StdClass {
	/**
	  ...
	  * @return Real[]
	  */
	private static function x2r($rd) { 
...
class Api {
	...
	/**
	  ...
	  * @return Real
	  */
	public static function get_real($id) {
		return self::get_reals(array($id));
	}
	...
	public static function get_reals(array $ids) {
		...
		return Real::x2r(file_get_contents($url));
	}
	...
	/**
	  ...
	  * @return void
	  */
	public static function delete_real($id) {
		return self::delete_reals(array($id));
	}
	...
	public static function delete_picture($id) {
		return self::delete_pictures(array($id));
	}
